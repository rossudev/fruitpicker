export let skuFunc = function(pickitem) {
	...
	if ( pickitem === "mac" ) {
		skus = {
			...
			['---1']: [ '---', '---', '---' ],
			['MYD82LL/A']: [ '13in MB Pro, 8/8 Cores, M1, 256GB, Space Gray', 'buy-mac/macbook-pro/13-inch-space-gray-apple-m1-chip-with-8-core-cpu-and-8-core-gpu-256gb', '$1299' ],
			['MYDA2LL/A']: [ '13in MB Pro, 8/8 Cores, M1, 256GB, Silver', 'buy-mac/macbook-pro/13-inch-silver-apple-m1-chip-with-8-core-cpu-and-8-core-gpu-256gb', '$1299' ],
			['MYD92LL/A']: [ '13in MB Pro, 8/8 Cores, M1, 512GB, Space Gray', 'buy-mac/macbook-pro/13-inch-space-gray-apple-m1-chip-with-8-core-cpu-and-8-core-gpu-512gb', '$1499' ],
			['MYDC2LL/A']: [ '13in MB Pro, 8/8 Cores, M1, 512GB, Silver', 'buy-mac/macbook-pro/13-inch-silver-apple-m1-chip-with-8-core-cpu-and-8-core-gpu-512gb', '$1499' ],
			['---2']: [ '---', '---', '---' ],
